                ...
                <div class="dashboard-body">
                    ...
                    <div class="dashboard-wraper">
                        ...
                        <div class="frm_submit_block">
                            <h4>News Management <a href="/admin/news/publish" class="btn btn-theme bg-2 btn-sm">Publish News</a></h4>
                        </div>
                        ...
                        <table class="property-table-wrap responsive-table">
                            ...
                            <c:forEach items="${pageInfo.records}" var="c">
                                <tr>
                                    ...
                                    <td class="action">
                                        <a href="/admin/news/publish?id=${c.id}" class="delete text-blue">Edit</a>
